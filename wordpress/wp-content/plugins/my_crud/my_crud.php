<?php
/*
    * Plugin Name: Exemplo de CRUD na tela de configuração do wordpress
    * Plugin URI: https://www.google.com.br
    * Description: Um crud de worpdress na tela de config
    * Version: 0.0.1
    * Author: Denilson Pereira
    * Author URI: https://github.com/denilson157
    * License: CC BY
    */
